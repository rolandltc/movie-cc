...
module.exports.ReO = function(res, data, code){ // Success Document Response
    if(typeof code !== 'undefined') res.statusCode = code;
...
module.exports.readDay = function(s) {
  const year = Number.parseInt(s.substring(0,4));
  const month = Number.parseInt(s.substring(4, 6));
  const day = Number.parseInt(s.substring(6,8));
